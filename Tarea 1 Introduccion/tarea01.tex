...
\begin{document}
    ...
    con la cadena $00$. En notación de conjuntos $\overline{L}$ es así:
    ...
    la topología algebraica. Según lo que encontramos en el pdf, su enfoque no es estudiar los elementos individuales que viven dentro
    ...
    pregunta, podemos pasar a las siguientes propiedades, las cuales consideramos que eran las más importantes:
    ...
    P? Según lo que llevamos de este curso, podemos decir que esta cae completamente en el mundo de las estructuras (U). Esto debido
    ...
    \begin{itemize}
        ...
        A ver, para este siguiente inciso creemos que es algo redundante, porque $L^*$ se supone que
