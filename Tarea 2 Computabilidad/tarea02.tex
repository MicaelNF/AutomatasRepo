...
\begin{document}
    ...
    entonces la máquina limpiara cualquier E-registro usado y regresará al espacio vacío a la derecha del último 1 y escribirá V, en el caso de 
    ...
    $q_{4}$ & $S_0, L, q_{11}$ & & $1, R, q_{5}$ & $C, R, q_{4}$ & \\ \hline
    $q_{5}$ & $C, L, q_{6}$ & & & & \\ \hline
    $q_{6}$ & $S_0, L, q_{6}$ & $0, L, q_{7}$ & $1, L, q_{6}$ & $C, L, q_{6}$ & \\ \hline
    $q_{7}$ & $S_0, L, q_{7}$ & & $1, L, q_{7}$ & $C, R, q_{8}$ & $I, R, q_{8}$ \\ \hline
    $q_{8}$ & & $0, R, q_{10}$ & $1, R, q_{9}$ & & \\ \hline
    $q_{9}$ & $C, R, q_{2}$ & & & $C, R, q_{9}$ & \\ \hline
    $q_{10}$ & $S_0, L, q_{15}$ & & $1, L, q_{11}$ & $C, R, q_{10}$ & \\ \hline
    $q_{11}$ & $S_0, L, q_{11}$ & $0, L, q_{11}$ & $1, L, q_{11}$ & $S_0, L, q_{11}$ & $S_0, R, q_{12}$ \\ \hline
    $q_{12}$ & $S_0, R, q_{13}$ & $0, R, q_{12}$ & $1, R, q_{12}$ & & \\ \hline
    $q_{13}$ & $S_0, L, q_{14}$ & $0, R, q_{12}$ & $1, R, q_{12}$ & & \\ \hline
    $q_{14}$ & $F, R, q_{19}$ & & & & \\ \hline
    $q_{15}$ & $S_0, L, q_{15}$ & $0, L, q_{15}$ & $1, L, q_{15}$ & $S_0, L, q_{15}$ & $S_0, R, q_{16}$ \\ \hline
    $q_{16}$ & $S_0, R, q_{17}$ & $0, R, q_{16}$ & $1, R, q_{16}$ & & \\ \hline
    $q_{17}$ & $S_0, L, q_{18}$ & $0, R, q_{16}$ & $1, R, q_{16}$ & & \\ \hline
    $q_{18}$ & $V, R, q_{19}$ & & & & \\ \hline
    $q_{19}$ & $S_0, RL, q_{19}$ & & & & \\ \hline
    \end{tabular}
    \end{table}
